...
public class ServicioContenedorSalidaTest {
	...
	public void calcularPagoDeUnDiaContenedorSinRestricciones() {
		...
		ServicioContenedorSalida servicioContenedorSalida = new ServicioContenedorSalida(repositorioHistorialAlmacenamiento);
		//Act 
